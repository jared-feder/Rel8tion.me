...
function normalizeVisitPayload(input = {}) {
  ...
  return {
    ...
    assignment_source: input.assignment_source || null,
    assigned_by_availability_id: input.assigned_by_availability_id || null,
...
function normalizeParticipantPayload(input = {}, visitId = '') {
  ...
  if (input.availability_id) payload.availability_id = input.availability_id;
  if (input.assignment_score !== undefined && input.assignment_score !== null) payload.assignment_score = input.assignment_score;
  if (input.assignment_reason) payload.assignment_reason = input.assignment_reason;
  return payload;
}
