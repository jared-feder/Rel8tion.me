...
async function requireReusableEventPassMembership(agentSlug, signId) {
  ...
  const error = new Error('REL8TION Agent membership is required to reuse this Event Pass for another open house. Tap the Event Pass NFC to continue membership setup.');
  error.status = 402;
  throw error;
}
