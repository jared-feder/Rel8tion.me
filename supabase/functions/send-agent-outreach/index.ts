...
const PUBLIC_APP_BASE_URL =
  (Deno.env.get("REL8TION_PUBLIC_BASE_URL") || Deno.env.get("PUBLIC_APP_URL") || "https://app.rel8tion.me")
    .replace(/\/$/, "");
const DEFAULT_SEND_MAX_PER_RUN = 25;
const SEND_MAX_PER_RUN_HARD_CAP = 25;
const DEFAULT_SEND_MAX_PER_HOUR = 100;
const SEND_MAX_PER_HOUR_HARD_CAP = 100;
const DEFAULT_SEND_MAX_PER_DAY = 500;
const SEND_MAX_PER_DAY_HARD_CAP = 500;
