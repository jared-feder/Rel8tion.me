...
comment on table public.agent_listing_inventory is
  'Service-only current listing inventory for claimed REL8TION agents and agents with positive outreach/working-relationship signals.';

comment on column public.agent_listing_inventory.relationship_status is
  'Why REL8TION follows this agent, such as worked_with, interested, confirmed_open_house, or accepted_open_house.';
