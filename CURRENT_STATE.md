...
- `[NEEDS VERIFICATION]` The toll-free number, Messaging Service SID, toll-free verification/use-case approval, MMS capability, sender-pool membership, inbound webhook, and live delivery are not yet verified. Production remains paused for `opt_out_rate_recovery`; do not release the 523-row pending backlog.
