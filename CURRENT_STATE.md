...
- `[RISK]` Automatic My Agents sending must remain on the protected preview branch until authenticated loan-officer dashboard ownership is enforced; a public profile UID alone is not a sufficient production authorization boundary.
