...
- `[NEEDS VERIFICATION]` A physical Event Pass tap through the NFC session exchange and closeout of a designated disposable test event remain manual field checks; no real open house was ended for release verification.
