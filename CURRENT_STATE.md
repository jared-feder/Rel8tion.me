...
- `[IMPLEMENTED]` On 2026-08-05, the owner directed every eligible August 8 row to go out the same day. Production release scope is active through `2026-08-09T04:00:00Z`, expires at `2026-08-06T03:59:00Z`, and excludes August 9 and later. The first scoped run sent 19 through Twilio under the rolling-hour ceiling; 12 were delivered, 6 remained sent at the initial check, and 1 failed with Twilio 21614 for a non-mobile destination. Thirty-two August 8 rows remained pending for subsequent 15-minute cron runs at that checkpoint.
