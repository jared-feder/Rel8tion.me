...
- `[IMPLEMENTED]` The owner-approved ceilings remain 7 per run, 20 per rolling hour, and 150 per rolling 24 hours, but opt-out recovery code now applies stricter hard caps of 5 per run, 5 per hour, and 5 per rolling 24 hours. Do not raise either the recovery caps or the approved ceilings without explicit owner approval and provider health review.
