...
- `[IMPLEMENTED]` Current owner-approved automatic outreach caps are 20 per run, 20 per rolling hour, and no more than 150 per rolling 24 hours. Do not raise these caps without explicit owner approval and provider health review.
