...
- `[IMPLEMENTED]` The owner-approved ceilings remain 7 per run, 20 per rolling hour, and 150 per rolling 24 hours, while the 2026-07-14 opt-out recovery lane applies stricter hard caps of 5 per run, 10 per hour, and 25 per rolling 24 hours. Do not raise either the recovery caps or the approved ceilings without explicit owner approval and provider health review.
