...
- `[IMPLEMENTED]` Loan Officer Coverage Sign chip behavior is different from the loan officer's personal keychain: the LO sign primary/front chip is public/event-facing, while the LO sign secondary/rear chip is the operator coverage/dashboard side.
