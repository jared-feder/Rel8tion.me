...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const [
      ...
      safeRest('agent_listing_inventory?is_current=eq.true&select=id,source_listing_id,agent_id,queue_row_id,agent_name,brokerage,phone,phone_normalized,email,listing_status,address,city,state,zip,price,image_url,listing_url,open_start,open_end,outreach_image_url,outreach_image_status,outreach_image_rendered_at,last_seen_at,updated_at&order=open_start.asc.nullslast,last_seen_at.desc&limit=3000', [], warnings, 'agent_listing_inventory'),
