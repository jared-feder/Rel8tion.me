...
- `[IMPLEMENTED]` As of 2026-06-24, Twilio operational SMS is restored via `SMS_PROVIDER=twilio`, `SMS_EVENTS_PROVIDER=twilio`, and `TWILIO_PHONE=+15168885461`. As of 2026-07-14, code support for a dedicated toll-free outreach lane exists, but its number, Messaging Service, verification, MMS capability, and live delivery still require verification; automatic outreach remains paused for opt-out recovery.
